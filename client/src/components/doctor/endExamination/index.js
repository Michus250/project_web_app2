...
//         } else {
//             const updatedExaminations = formData.examinations.filter((examination) => examination !== value);
...
//             const response = await axios.post('/endExamination', formData);
...
//                                 <div className="card-header">{visit.user_id.firstName} {visit.user_id.lastName} {new Date(visit.date).toLocaleDateString("pl-PL")} {new Date(visit.date).toLocaleTimeString("pl-PL", {
//                                     hour: "numeric",
//                                     minute: "numeric",
//                                 })}</div>
...
//                                             <label htmlFor="nameExamination" className="col-md-4 col-form-label text-md-end">Nazwa</label>
...
//                                                     name="name"
//                                                     value={formData.nameExamination}
...
//                                         </div>
//                                         <div className="row mb-3">
//                                             <label htmlFor="description" className="col-md-4 col-form-label text-md-end">Opis</label>
//                                             <div className="col-md-6">
//                                                 <input
//                                                     id="description"
//                                                     type="text"
...
//                                         </div>
//                                         <div className="row mb-3">
//                                             <label htmlFor="examinations" className="col-md-4 col-form-label text-md-end">Badania</label>
//                                             <div className="col-md-6">
...
//                                         <input type="submit" className="btn btn-secondary my-1 mx-1" value="Zatwierdź"></input>
//                                     </form>
//                                 </div>
//                             </div>
//                         </div>
